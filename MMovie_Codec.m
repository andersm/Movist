...
+ (int)audioCodecIdFromFFmpegCodecId:(int)ffmpegCodecId
{
    ...
    switch (ffmpegCodecId) {
		...
		CASE_FFCODEC_MCODEC(WMAVOICE,       WMAVOICE);
		CASE_FFCODEC_MCODEC(WMAPRO,         WMAPRO);
		CASE_FFCODEC_MCODEC(WMALOSSLESS,    WMALOSSLESS);
		CASE_FFCODEC_MCODEC(ATRAC3P,        ATRAC3P);
		CASE_FFCODEC_MCODEC(EAC3,           EAC3);
		CASE_FFCODEC_MCODEC(SIPR,           SIPR);
		CASE_FFCODEC_MCODEC(MP1,            MP1);
		CASE_FFCODEC_MCODEC(TWINVQ,         TWINVQ);
		CASE_FFCODEC_MCODEC(TRUEHD,         TRUEHD);
		CASE_FFCODEC_MCODEC(MP4ALS,         MP4ALS);
		CASE_FFCODEC_MCODEC(ATRAC1,         ATRAC1);
		CASE_FFCODEC_MCODEC(BINKAUDIO_RDFT, BINKAUDIO_RDFT);
		CASE_FFCODEC_MCODEC(BINKAUDIO_DCT,  BINKAUDIO_DCT);
		CASE_FFCODEC_MCODEC(AAC_LATM,       AAC_LATM);
		CASE_FFCODEC_MCODEC(QDMC,           QDMC);
		CASE_FFCODEC_MCODEC(CELT,           CELT);
    }
