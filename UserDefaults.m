...
NSString* MAlwaysOnTopOnPlayingKey          = @"AlwaysOnTopOnPlaying";
...
//NSString* MSubtitleHPositionKey             = @"SubtitleHPosition";
NSString* MSubtitleVPositionKey             = @"SubtitleVPosition";
...
NSString* MUsePlayPanelKey                  = @"UsePlayPanel";
...
- (void)registerMovistDefaults
{
    ...
    [dict setObject:[NSNumber numberWithBool:FALSE] forKey:MAlwaysOnTopOnPlayingKey];
    ...
    [dict setObject:[NSKeyedArchiver archivedDataWithRootObject:textColor requiringSecureCoding:NO error:nil] forKey:MSubtitleTextColorKey];
	[dict setObject:[NSKeyedArchiver archivedDataWithRootObject:strokeColor requiringSecureCoding:NO error:nil] forKey:MSubtitleStrokeColorKey];
	[dict setObject:[NSNumber numberWithFloat:4.0] forKey:MSubtitleStrokeWidthKey];
	[dict setObject:[NSKeyedArchiver archivedDataWithRootObject:shadowColor requiringSecureCoding:NO error:nil] forKey:MSubtitleShadowColorKey];
    ...
    [dict setObject:[NSNumber numberWithBool:TRUE] forKey:MUsePlayPanelKey];
    ...
    [dict setObject:[NSNumber numberWithInt:WINDOW_RESIZE_ADJUST_TO_WIDTH] forKey:MWindowResizeModeKey];
...
- (NSDictionary*)defaultCodecBinding
{
    ...
    return [NSDictionary dictionaryWithObjectsAndKeys:
            ...
            CODEC_BINDING(DECODER_FFMPEG,   MCODEC_HEVC),
            ...
            CODEC_BINDING(DECODER_FFMPEG,   MCODEC_VP8),
            CODEC_BINDING(DECODER_FFMPEG,   MCODEC_VP9),
